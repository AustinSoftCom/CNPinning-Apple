...
struct CNPinningManagerTests {
    ...
    @Test func cnPinningManagerGetConfigurationExact() throws {
        ...
        #expect(pinningManager.getConfiguration(for: "www.apple.com") == testConfiguration)
    }
    ...
    @Test func cnPinningManagerGetSubdomainConfiguration() throws {
        ...
        #expect(pinningManager.getConfiguration(for: "sub.apple.com") == testConfiguration)
    }
    ...
    @Test func cnPinningManagerGetDomainConfiguration() throws {
        ...
        #expect(pinningManager.getConfiguration(for: "apple.com") == testConfiguration)
    }
    ...
    @Test func cnPinningManagerGetLongerDomainConfiguration() throws {
        ...
        #expect(pinningManager.getConfiguration(for: "sub.www.apple.com") == testConfiguration)
    }
